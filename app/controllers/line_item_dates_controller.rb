class LineItemDatesController < ApplicationController
  ...
  def create
    ...
    if @line_item_date.save
      respond_to do |format|
        format.html { redirect_to quote_path(@quote), flash: { success: 'Date was successfully created.' } }
        format.turbo_stream { flash.now[:success] = 'Date was successfully created.' }
      end
    else
  ...
  def update
    if @line_item_date.update(line_item_date_params)
      respond_to do |format|
        format.html { redirect_to quote_path(@quote), flash: { notice: 'Date was successfully updated.' } }
